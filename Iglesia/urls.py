...
urlpatterns = patterns('',
    ...
    url(r'^miembro/editar_detalle_llamada/$',  editarDetalleLlamada),
    ...
    url(r'^grupo/editar_red/$', editarRed),
    ...
    url(r'^grupo/editar_predica/$', editarPredica),
