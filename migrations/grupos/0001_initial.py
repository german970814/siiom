...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Red'
        db.create_table('grupos_red', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('grupos', ['Red'])

        # Adding model 'Grupo'
        db.create_table('grupos_grupo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lider1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lider_uno', to=orm['miembros.Miembro'])),
            ('lider2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='lider_dos', null=True, to=orm['miembros.Miembro'])),
            ...
            ('fechaApertura', self.gf('django.db.models.fields.DateField')()),
            ('diaGAR', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('horaGAR', self.gf('django.db.models.fields.TimeField')()),
            ('diaDiscipulado', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('horaDiscipulado', self.gf('django.db.models.fields.TimeField')()),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('red', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grupos.Red'], null=True, blank=True)),
            ('barrio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['miembros.Barrio'])),
        ))
        db.send_create_signal('grupos', ['Grupo'])

        # Adding model 'Predica'
        db.create_table('grupos_predica', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('grupos', ['Predica'])

        # Adding model 'ReunionGAR'
        db.create_table('grupos_reuniongar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')()),
            ('grupo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grupos.Grupo'])),
            ('predica', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('numeroTotalAsistentes', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('numeroLideresAsistentes', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('numeroVisitas', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('novedades', self.gf('django.db.models.fields.TextField')(default='nada', max_length=500, null=True, blank=True)),
            ('ofrenda', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('confirmacionEntregaOfrenda', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('grupos', ['ReunionGAR'])

        # Adding model 'AsistenciaMiembro'
        db.create_table('grupos_asistenciamiembro', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('miembro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['miembros.Miembro'])),
            ('reunion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grupos.ReunionGAR'])),
            ('asistencia', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('grupos', ['AsistenciaMiembro'])

        # Adding model 'ReunionDiscipulado'
        db.create_table('grupos_reuniondiscipulado', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fecha', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('grupo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grupos.Grupo'])),
            ('predica', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grupos.Predica'])),
            ('numeroLideresAsistentes', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('novedades', self.gf('django.db.models.fields.TextField')(max_length=500)),
            ('ofrenda', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('confirmacionEntregaOfrenda', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('grupos', ['ReunionDiscipulado'])

        # Adding model 'AsistenciaDiscipulado'
        db.create_table('grupos_asistenciadiscipulado', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('miembro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['miembros.Miembro'])),
            ('reunion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['grupos.ReunionDiscipulado'])),
            ('asistencia', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('grupos', ['AsistenciaDiscipulado'])


    def backwards(self, orm):
        # Deleting model 'Red'
        db.delete_table('grupos_red')

        # Deleting model 'Grupo'
        db.delete_table('grupos_grupo')

        # Deleting model 'Predica'
        db.delete_table('grupos_predica')

        # Deleting model 'ReunionGAR'
        db.delete_table('grupos_reuniongar')

        # Deleting model 'AsistenciaMiembro'
        db.delete_table('grupos_asistenciamiembro')

        # Deleting model 'ReunionDiscipulado'
        db.delete_table('grupos_reuniondiscipulado')

        # Deleting model 'AsistenciaDiscipulado'
        db.delete_table('grupos_asistenciadiscipulado')
    ...
    models = {
        ...
        'grupos.reuniondiscipulado': {
            ...
            'ofrenda': ('django.db.models.fields.PositiveIntegerField', [], {}),
