...
urlpatterns = [
    # url(r'^visitas_por_red/$', views.visitasAsignadasRedes, name="visitas_por_red"),  # revisada en desuso
    # url(r'^asignacion_gar/$', views.asignacionGAR, name="asignacion_gar"),  # revisada  en desuso
    # url(r'^primera_llamada/$', views.detalleLlamada, {'llamada': 1}, name="primera_llamada"),  # revisada  en desuso
    # url(r'^segunda_llamada/$', views.detalleLlamada, {'llamada': 2}, name="segunda_llamada"),  # revisada  en desuso
    # url(r'^visitas_por_mes/$', views.visitasPorMes, {'por_red': False}, name="visitas_por_mes"),  # revisada  en desuso
    # url(r'^visitas_red_por_mes/$', views.visitasPorMes, {'por_red': True}, name="visitas_red_por_mes"),  # revisada  en desuso
    # url(r'^asistencia_reuniones/$', views.asistenciaGrupos, name="asistencia_reuniones"),  # revisada la asistencia ya no se lleva, en desuso
    ...
    # url(r'^cumplimiento_llamadas_lideres/$', views.cumplimiento_llamadas_lideres_red, name='cumplimiento_llamadas_lideres'),  # revisada en desuso
    # url(r'^reportes_reuniones_sin_enviar/$', views.ConsultarReportesSinEnviar, {}, name="reportes_reuniones_sin_enviar"),  # revisada  en desuso
    ...
    #     name="reportes_reuniones_discipulado_sin_enviar"),  # No asignado aun a ningun menu revisada, en desuso
    ...
    #     name="consultar_sobres_discipulados_sin_enviar"),  # Error revisada en desuso
