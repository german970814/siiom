...
urlpatterns = [
    ...
    url(r'^editar_miembros/$', liderEditarMiembros, name="editar_miembros"),
    url(r'^editar_miembro/(\d+)/$', editarMiembro, name="editar_miembro"),
    url(r'^transladar_miembros/$', liderTransaldarMiembro, name="transladar_miembros"),
    ...
    url(r'^editar_barrio/$',  editarBarrio, name="editar_barrio"),
